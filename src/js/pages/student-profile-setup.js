  ...
  <div class="container" style="padding: 1.5rem 1rem 2rem 1rem; max-width: 1200px;">
    ...
    <div class="card page-header">
      ...
      <div style="flex:1">
        ...
        <div class="subtitle">
          <div>ID <strong style="margin-left:.4rem">${
            user.studentId || "—"
          }</strong></div>
          <div>Tốt nghiệp <strong style="margin-left:.4rem">${
            user.graduation || "—"
          }</strong></div>
          <div>Mạng xã hội <a href="${
            user.github || "#"
          }" target="_blank" rel="noopener" style="color:#00BCD4">${
    user.github ? user.github : "Thêm GitHub"
  }</a></div>
      ...
      <div class="card">
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:1rem;">
          <div class="form-group input-with-icon">
            ...
            <input id="pf-fullname" class="form-input" type="text" placeholder="Họ và tên" value="${
              user.fullName || ""
            }" />
          </div>
          ...
          <div class="form-group input-with-icon">
            ...
            <input id="pf-student-id" class="form-input" type="text" placeholder="Mã sinh viên" value="${
              user.studentId || ""
            }" />
          </div>
          <div class="form-group input-with-icon">
            <svg class="input-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M7 11h10M7 15h7M3 4h18v16H3z"/></svg>
            <input id="pf-graduation" class="form-input" type="month" placeholder="Tháng tốt nghiệp" value="${
              user.graduation || ""
            }" />
          </div>
          <div class="form-group input-with-icon">
          ...
          <div class="form-group input-with-icon">
            ...
            <input id="pf-phone" class="form-input" type="tel" placeholder="Số điện thoại" value="${
              user.phone || ""
            }" />
          </div>
          <div class="form-group input-with-icon" style="grid-column: span 2;">
            ...
            <input id="pf-email" class="form-input" type="email" placeholder="Email" value="${
              user.email || ""
            }" />
          </div>
          <div class="form-group input-with-icon" style="grid-column: span 2;">
            ...
            <input id="pf-country" class="form-input" type="text" placeholder="Quốc gia" value="${
              user.country || ""
            }" />
          </div>
        </div>
        ...
        <div class="list-rows">
          <div class="row grid-2">
            <div class="form-group input-with-icon">
              ...
              <input id="pf-edu-university" class="form-input" type="text" placeholder="Đại học" value="${
                user.university || ""
              }" />
            </div>
            <div class="form-group input-with-icon">
              <svg class="input-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16v4H4zM4 10h10v4H4z"/></svg>
              <input id="pf-edu-faculty" class="form-input" type="text" placeholder="Khoa" value="${
                user.faculty || ""
              }" />
            </div>
          </div>
          <div class="row grid-3">
            <div class="form-group input-with-icon">
              <svg class="input-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M19 4h-4l-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"/></svg>
              <input id="pf-edu-code" class="form-input" type="text" placeholder="Mã số sinh viên" value="${
                user.studentCode || user.studentId || ""
              }" />
            </div>
            <div class="form-group input-with-icon">
              <svg class="input-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M7 11h10M7 15h7M3 4h18v16H3z"/></svg>
              <input id="pf-edu-graduation" class="form-input" type="month" placeholder="Dự kiến tốt nghiệp" value="${
                user.graduation || ""
              }" />
            </div>
            <div class="form-group input-with-icon">
              <svg class="input-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 100 20 10 10 0 000-20z"/></svg>
              <input id="pf-edu-gpa" class="form-input" type="text" placeholder="GPA" value="${
                user.gpa || ""
              }" />
            </div>
          </div>
        ...
        <div id="cert-list" class="list-rows">
          ${(user.certificates || [])
            ...
            <div class="row grid-cert row-cert">
              <input class="form-input cert-name" placeholder="Tên chứng chỉ (vd: JLPT, IELTS)" value="${
                c.name || ""
              }" />
              <input class="form-input cert-value" placeholder="Giá trị (vd: N4, 6.0)" value="${
                c.value || ""
              }" />
              <input class="form-input cert-date" type="date" value="${(
                c.date || ""
              ).replaceAll("/", "-")}" />
        ...
        <div id="award-list" class="list-rows">
          ${(user.awards || [])
            ...
            <div class="row grid-award row-award">
              <input class="form-input award-title" placeholder="Tên giải thưởng" value="${
                a.title || ""
              }" />
              <input class="form-input award-date" type="date" value="${(
                a.date || ""
              ).replaceAll("/", "-")}" />
              <button class="btn btn-outline btn-icon" onclick="this.parentElement.remove()">Xóa</button>
            </div>
        ...
        <div id="highlight-list" class="list-rows">
          ${(user.highlights || [])
            ...
            <div class="row row-highlight">
              <input class="form-input highlight-text" placeholder="Mô tả ngắn điểm mạnh / thành tích" value="${
                h || ""
              }" />
              <button class="btn btn-outline btn-icon" onclick="this.parentElement.remove()">Xóa</button>
            </div>
        ...
        <div id="skill-list" class="list-rows">
          ${(user.skills || [])
            ...
            <div class="row grid-skill row-skill">
              <input class="form-input skill-name" placeholder="Tên kỹ năng (vd: React, Node.js)" value="${
                s.name || ""
              }" />
              <input class="form-input skill-months" type="number" min="0" placeholder="Số tháng kinh nghiệm" value="${
                s.months || ""
              }" />
              <button class="btn btn-outline btn-icon" onclick="this.parentElement.remove()">Xóa</button>
            </div>
