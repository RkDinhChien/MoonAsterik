...
const app = {
	...
	renderPage() {
		...
		// Initialize stats animation and logo click effect if on landing page
		...
		if (!state.isLoggedIn) {
			setTimeout(() => {
				...
				if (window.PageTemplates.initLogoClickEffect) {
					window.PageTemplates.initLogoClickEffect();
				}
			}, 100);
		}
	},
